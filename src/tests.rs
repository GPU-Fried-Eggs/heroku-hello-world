...
#[track_caller]
fn test_query_file<T> (path: &str, file: T, status: Status) where T: Into<Option<&'static str>>
{
...
fn test_index_html() {
    ...
    test_query_file("/pkg/", "static/index.html", Status::Ok);
    test_query_file("/pkg/?v=1", "static/index.html", Status::Ok);
}
